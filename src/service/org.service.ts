...
export class OrgService {
  ...
  public async updateOrgProfile(
    id: string,
    updateBody: UpdateOrgBody
    ...
    const newLicense = Object.assign(org.license, updateBody.license);
    const newAddress = Object.assign(org.address, updateBody.address);
    Object.assign(org, updateBody);
    org.license = newLicense;
    org.address = newAddress;
